...
void Game::resetGame() {
	for (int i = 0; i < 3; i++) {
		this->playerPawns[i].setPosition(2, i);
		this->playerPawns[i].replace();
		this->curBoard[0][i] = 'e';
		this->curBoard[1][i] = '.';
		this->curBoard[2][i] = 'p';
	}
